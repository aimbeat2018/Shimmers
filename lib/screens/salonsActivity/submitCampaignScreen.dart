                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  salonController.campaignQuestionListModel!
                                      .data![index].question!,
                                  style: const TextStyle(
                                      color: primaryColor,
                                      fontSize: 16,
                                ...
                                if (salonController.campaignQuestionListModel!
                  ...
                  child: salonController.isLoading
                      ...
                      : ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            for (var campaignQuestionData in salonController
                                .campaignQuestionListModel!.data!) {
                              UsersAnswer userAnswer = UsersAnswer();
                              userAnswer.questionId = campaignQuestionData.id;

                              List<Answers> answersList = [];
                              for (var string
                                  in campaignQuestionData.selectedAnswerList!) {
